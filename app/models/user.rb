...
#   # Devise integration
#   devise :database_authenticatable, :registerable, :confirmable, :validatable, :recoverable, :omniauthable, omniauth_providers: [:facebook, :google_oauth2]
#   # Associations
...
#     readings.any? ? "#{time_ago_in_words(readings.last.created_at)} ago" : "Never"
#   end
